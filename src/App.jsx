...
function App() {
  ...
  const recentAlerts = [
    { id: 1, time: "10:42 AM", msg: "SpO2 dropped below 92%", type: "warning" },
    { id: 2, time: "09:15 AM", msg: "System online & calibrated", type: "info" },
  ];

  // Only listen to Firebase if the user is authenticated
  useEffect(() => {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // Hardcoded Medical PIN for prototyping (Change this to whatever you want)
    if (pinCode === '1234') {
  ...
  // ==========================================
  // VIEW 2: THE DASHBOARD (from previous step)
  // ==========================================
  return (
      ...
      <div className="main-layout">
        ...
        <main className="content-area">
          ...
          <div className="panel graph-panel">
            ...
            {history.length === 0 ? (
              <div className="empty-state">Awaiting sensor telemetry...</div>
            ) : (
